const C='veriodetect-v076';
const A=['./','./index.html','./styles.css','./app.js?v=076','./engine.js?v=076','./handoff.js?v=076','./m2.js?v=076','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
